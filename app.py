...
api_url = "https://detect.roboflow.com/YOUR_MODEL/YOUR_VERSION"
api_key = "YOUR_API_KEY"  # Use os.getenv('ROBOFLOW_API_KEY') if stored in GitHub Secrets

response = requests.post(f"{api_url}?api_key={api_key}")

print(response.status_code)
print(response.text)  # Check if Roboflow returns more error details
